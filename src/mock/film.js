...
import {
  ...
  FILM_DESCRIPTIONS,
  FILM_IMAGES,
  FILM_TITLES, GENRES, MAX_ACTORS_COUNT,
  MAX_DESCRIPTION_SIZE, MAX_RATING, MAX_WRITERS_COUNT, MIN_ACTORS_COUNT,
  MIN_DESCRIPTION_SIZE, MIN_RATING, MIN_WRITERS_COUNT,
  ORIGINAL_FILM_TITLES, WRITERS
} from "./mock";
